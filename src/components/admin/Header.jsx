...
export default function Header({ onMenuToggle }) {
  ...
  return (
    <header className="bg-white dark:bg-slate-900 px-4 md:px-6 py-3.5 flex items-center justify-between border-b border-slate-200/60 dark:border-slate-800 z-30 sticky top-0">
